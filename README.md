...
Load the Bitcoin historical price dataset and explore its structure by checking rows, columns, and data types.

Step 3: Data Preprocessing

Handle missing values, convert the date column into datetime format, and normalize numerical features using MinMaxScaler.

Step 4: Feature Engineering

Create technical indicators such as Simple Moving Average (SMA), Exponential Moving Average (EMA), Bollinger Bands, and Relative Strength Index (RSI) to capture market trends.

Step 5: Train-Test Split

Split the dataset into training data (80%) and testing data (20%) to train and evaluate the models.

Step 6: Data Visualization

Visualize Bitcoin price trends over time and analyze relationships between different indicators.
...
Evaluate model performance using metrics such as RMSE, MAE, MSE, and R² Score.
